function previewImage() {
  ...
  // More API functions here:
    ...
    const URL = "https://teachablemachine.withgoogle.com/models/05L3alS6Y/";
    ...
    async function init() {
        ...
        predict();
        document.getElementById("location-src").innerText = "Clique aqui para enviar a imagem e verificar a fase do café";
    }
